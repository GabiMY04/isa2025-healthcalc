...
![Compilación exitosa](doc/CompilacionCompile_practica7.png)
### mvn test
En la imagen se muestra que de los 11 test no ha habido ningun fallo
![Tests exitosos](doc/CompilacionTest_practica7.png)

## Resultados interfaz grafica
![Demo de la interfaz](doc/Prueba_compilacion.gif)
